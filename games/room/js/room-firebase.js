    async function saveRoom() {
      ...
      const data = {
        ...
        farmAgedDay: roomData.farmAgedDay || '',
        farmAgedSold: roomData.farmAgedSold || 0,
