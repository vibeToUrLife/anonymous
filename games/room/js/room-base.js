    ...
    const FARM_THEMES = [
      {
        ...
        day: {
          ...
          soilFx: [{ kind: 'clod', count: 130, size: 4.2, alpha: 0.55,
                     color: '86,58,30', lit: '162,120,72', shade: '46,30,14', stone: '150,138,120' }],
        ...
        night: {
          ...
          soilFx: [{ kind: 'clod', count: 80, size: 4.0, alpha: 0.32,
                     color: '46,33,16', lit: '86,64,36', shade: '22,15,7', stone: '92,86,76' }],
      ...
      },
      {
        ...
        day: {
          grass: ['#e0a83a', '#c98c22', '#a86f14'], soil: ['#7a4a22', '#4d2d12'],
          hillFar: '#c98f36', hillNear: '#a97420',
          penTint: 'rgba(210,160,60,0.16)', groundShadow: 'rgba(70,40,0,.26)',
          soilFx: [{ kind: 'clod', count: 140, size: 4.4, alpha: 0.55,
                     color: '104,64,26', lit: '196,146,74', shade: '54,32,10', stone: '178,158,124' }],
        ...
        night: {
          grass: ['#3a2a10', '#2c200c', '#1f1608'], soil: ['#33200e', '#1d1207'],
          hillFar: '#2a1d0c', hillNear: '#352612',
          penTint: 'rgba(110,80,25,0.18)',
          soilFx: [{ kind: 'clod', count: 85, size: 4.2, alpha: 0.32,
                     color: '52,34,14', lit: '98,70,34', shade: '26,16,6', stone: '96,88,74' }],
      ...
      },
      {
        ...
        day: {
          ...
          soilFx: [{ kind: 'clod', count: 120, size: 4.0, alpha: 0.50,
                     color: '74,80,88', lit: '186,204,220', shade: '38,42,50', stone: '208,220,232' }],
        ...
        night: {
          grass: ['#8fa4bd', '#6f8098', '#4f5d73'], soil: ['#2a2f37', '#171a20'],
          hillFar: '#8ea4bd', hillNear: '#6d7f98',
          penTint: 'rgba(70,95,125,0.18)',
          soilFx: [{ kind: 'clod', count: 70, size: 3.8, alpha: 0.30,
                     color: '38,42,50', lit: '96,112,130', shade: '20,23,28', stone: '120,136,152' }],
      ...
      },
      {
        ...
        day: {
          ...
          soilFx: [{ kind: 'clod', count: 130, size: 4.2, alpha: 0.52,
                     color: '124,84,74', lit: '198,150,132', shade: '70,44,40', stone: '186,164,158' }],
        ...
        night: {
          ...
          soilFx: [{ kind: 'clod', count: 80, size: 4.0, alpha: 0.30,
                     color: '58,40,36', lit: '104,74,66', shade: '30,20,18', stone: '104,92,88' }],
