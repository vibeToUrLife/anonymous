    ...
    const FARM_THEMES = [
      ...
      {
        id: 'harvest', emoji: '🌾', name: 'Golden Harvest', cost: 3000, blurb: 'golden fields · drifting chaff',
        day: {
          ...
          leaf: '#c9a23a', leafLight: 'rgba(246,222,138,0.70)', leafMid: 'rgba(206,166,58,0.26)', leafDapple: 'rgba(253,240,186,0.62)',
          sky: 'rgba(255,186,96,0.20)',
          weather: { kind: 'mote', count: 34, color: '255,232,150', size: 1.9, speed: 9, sway: 26, alpha: 0.55 },
        },
        night: {
          ...
          leaf: '#4a3a12', leafLight: 'rgba(150,124,50,0.50)', leafMid: 'rgba(80,64,22,0.20)', leafDapple: 'rgba(190,166,92,0.36)',
          sky: 'rgba(180,120,50,0.16)',
          weather: { kind: 'mote', count: 24, color: '220,196,120', size: 1.7, speed: 8, sway: 24, alpha: 0.30 },
        },
      },
      {
        id: 'winter', emoji: '❄️', name: 'Winter Farm', cost: 8000, blurb: 'deep snow · falling flakes',
        day: {
          ...
          leaf: '#4e7a58', leafLight: 'rgba(236,246,252,0.70)', leafMid: 'rgba(150,186,200,0.24)', leafDapple: 'rgba(255,255,255,0.85)',
          sky: 'rgba(190,220,246,0.24)',
          weather: { kind: 'snow', count: 60, color: '255,255,255', size: 2.6, speed: 34, sway: 20, alpha: 0.90 },
        },
        night: {
          ...
          leaf: '#22364a', leafLight: 'rgba(150,180,210,0.45)', leafMid: 'rgba(60,90,120,0.20)', leafDapple: 'rgba(220,235,250,0.55)',
          sky: 'rgba(90,130,180,0.18)',
          weather: { kind: 'snow', count: 44, color: '225,238,252', size: 2.4, speed: 30, sway: 18, alpha: 0.60 },
        },
      },
      {
        id: 'sakura', emoji: '🌸', name: 'Blossom Season', cost: 15000, blurb: 'blossom trees · drifting petals',
        day: {
          ...
          leaf: '#f3a6c6', leafLight: 'rgba(255,225,238,0.74)', leafMid: 'rgba(240,160,196,0.26)', leafDapple: 'rgba(255,248,252,0.72)',
          sky: 'rgba(255,196,222,0.20)',
          weather: { kind: 'petal', count: 40, color: '255,190,214', size: 3.4, speed: 20, sway: 34, alpha: 0.85 },
        },
        night: {
          ...
          leaf: '#5a3350', leafLight: 'rgba(190,140,180,0.48)', leafMid: 'rgba(110,70,105,0.20)', leafDapple: 'rgba(230,190,220,0.45)',
          sky: 'rgba(150,90,140,0.16)',
          weather: { kind: 'petal', count: 28, color: '210,150,180', size: 3.0, speed: 18, sway: 30, alpha: 0.50 },
        },
      },
    ];
